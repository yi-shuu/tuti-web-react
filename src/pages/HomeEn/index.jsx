        ...
        return (
            <>
                ...
                <div style={{ marginTop: "70px" }}>
                    <VStack>
                        <Text fontWeight="bold" fontSize={24}>Do you aspire to be a global leader of the future?</Text>
                        <Text fontSize={16} lineHeight="1.0">Are you read to shine on the global stage?</Text>
                        <Text fontSize={16} lineHeight="1.0">Tuti's innovative AI education platform is the perfect companion</Text>
                        <Text fontSize={16} lineHeight="1.0">to transform you into a global talent. Inquire now!</Text>
                    </VStack>
                </div>
                <div style={{ marginTop: "100px" }}>
                    <VStack>
                        <Text fontWeight="bold" fontSize={22}>Are you ready to register?</Text>
                    </VStack>
                </div>
                ...
                <div style={{ width: '100%', marginTop: "90px", display: "flex", justifyContent: 'center' }}>
                    <VStack>
                        <HStack spacing={3} marginLeft={5}>
                            <Text fontWeight="bold" color="gray.400" fontSize={16}>#ExchangeStudent</Text>
                            <Text fontWeight="bold" color="gray.400" fontSize={16}>#Internship</Text>
                            <Text fontWeight="bold" color="gray.400" fontSize={16}>#GlobalExchange</Text>
                        </HStack>
                        <HStack spacing={3} marginLeft={5}>
                            <Text fontWeight="bold" color="gray.400" fontSize={16}>#CareerExploration</Text>
                            <Text fontWeight="bold" color="gray.400" fontSize={16}>#StrengtheningResume</Text>
                            <Text fontWeight="bold" color="gray.400" fontSize={16}>#GlobalVolunteer</Text>
                        </HStack>
                    </VStack>
                </div>
                <div style={{ marginTop: "100px", display: "flex" }}>
                    <Text fontWeight="bold" fontSize={24} marginLeft={5}>University in Korea</Text>
                </div>
                <div>
                    <VStack>
        ...
        return (
            <>
                ...
                <div style={{ marginTop: "80px" }}>
                    <VStack>
                        <Text fontWeight="bold" fontSize={32}>Do you aspire to be a global leader of the future?</Text>
                        <Text fontSize={25} lineHeight="1.0">Are you read to shine on the global stage?</Text>
                        <Text fontSize={25} lineHeight="1.0">Tuti's innovative AI education platform is the perfect companion</Text>
                        <Text fontSize={25} lineHeight="1.0">to transform you into a global talent. Inquire now!</Text>
                    </VStack>
                </div>
                <div style={{ marginTop: "120px" }}>
                    <VStack>
                        <Text fontWeight="bold" fontSize={28}>Are you ready to register?</Text>
                    </VStack>
                </div>
                <div style={{ marginTop: "20px" }}>
                    <VStack>
                        <ExternalLinkButton url="https://forms.gle/rmfDTTALSMHzTaEt8" text="Apply now" />
                    </VStack>
                </div>
                <div style={{ width: '100%', marginTop: "120px", display: "flex", justifyContent: 'center' }}>

                    <HStack spacing={10} marginLeft={5}>
                        <Text fontWeight="bold" color="gray.400" fontSize={19}>#ExchangeStudent</Text>
                        <Text fontWeight="bold" color="gray.400" fontSize={19}>#Internship</Text>
                        <Text fontWeight="bold" color="gray.400" fontSize={19}>#GlobalExchange</Text>
                        <Text fontWeight="bold" color="gray.400" fontSize={19}>#CareerExploration</Text>
                        <Text fontWeight="bold" color="gray.400" fontSize={19}>#StrengtheningResume</Text>
                        <Text fontWeight="bold" color="gray.400" fontSize={19}>#GlobalVolunteer</Text>
                    </HStack>

                </div>
                <div style={{ marginTop: "120px", display: "flex" }}>
                    <Text fontWeight="bold" fontSize={30} marginLeft={10}>University in Korea</Text>
                </div>
                <div>
                    <VStack>

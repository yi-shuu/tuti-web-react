        ...
        return (
            <>
                <HStack>
                    <VStack marginTop={5}>
                        ...
                        >
                            <VStack>
                                <Link to="/company">
                                    <Text lineHeight={10} cursor="pointer" _hover={{ backgroundColor: "gray.100", padding: "1px 10px" }} rounded='md'>会社紹介</Text>
                                </Link>
                                <Link to="/*">
                                    <Text lineHeight={10} cursor="pointer" _hover={{ backgroundColor: "gray.100", padding: "1px 10px" }} rounded='md'>就職</Text>
                                </Link>
                                <Link to="/*">
                                    <Text lineHeight={10} cursor="pointer" _hover={{ backgroundColor: "gray.100", padding: "1px 10px" }} rounded='md'>大学</Text>
                                </Link>
                                <Link to="/*">
                                    <Text lineHeight={10} cursor="pointer" _hover={{ backgroundColor: "gray.100", padding: "1px 10px" }} rounded='md'>コミュ</Text>
                                </Link>
                                <Link to='/*'>
                                    <Text lineHeight={10} cursor="pointer" _hover={{ backgroundColor: "gray.100", padding: "1px 10px" }} rounded='md'>勉強カフェ</Text>
                                </Link>
                            </VStack>
                        </Drawer>
                    </VStack>
                        ...
                        <Popover
                            ...
                            <HStack justify="center">
                                <VStack align="start" spacing={3}>
                                    <CustomHeading image={require("../../assets/instagram.png")} imageSize="20px" text="インスタグラム" url="https://www.instagram.com/tuti_platform/" />
                                    <CustomHeading image={require("../../assets/kakaologo.png")} imageSize="20px" text="カカオトーク" url="https://pf.kakao.com/_jXxdxmG" />
                                    <CustomHeading image={require("../../assets/line.png")} imageSize="20px" text="ライン" url="https://pf.kakao.com/_jXxdxmG" />
                ...
                <div style={{ marginTop: "70px" }}>
                    <VStack>
                        <Text fontWeight="bold" fontSize={24}>未来のグローバルリーダーに</Text>
                        <Text fontWeight="bold" fontSize={24}>なりたいですか？</Text>
                        <Text fontSize={16} lineHeight="1.0">大学生の皆さん、世界舞台で輝く準備はできましたか？</Text>
                        <Text fontSize={16} lineHeight="1.0">Tutiの革新的なAI教育プラットフォームがあなたを</Text>
                        <Text fontSize={16} lineHeight="1.0">グローバルな才能にする生まれ変わる最適な仲間です。</Text>
                        <Text fontSize={16} lineHeight="1.0">今すぐお問い合わせください！</Text>
                    </VStack>
                </div>
                <div style={{ marginTop: "100px" }}>
                    <VStack>
                        <Text fontWeight="bold" fontSize={22}>登録する準備ができましたか？</Text>
                    </VStack>
                </div>
                ...
                <div style={{ width: '100%', marginTop: "90px", display: "flex", justifyContent: 'center' }}>
                    <VStack>
                        <HStack spacing={3} marginLeft={5}>
                            <Text fontWeight="bold" color="gray.400" fontSize={16}>#交換学生</Text>
                            <Text fontWeight="bold" color="gray.400" fontSize={16}>#インターンシップ</Text>
                            <Text fontWeight="bold" color="gray.400" fontSize={16}>#国際交流</Text>
                        </HStack>
                        <HStack spacing={3} marginLeft={5}>
                            <Text fontWeight="bold" color="gray.400" fontSize={16}>#進路探索</Text>
                            <Text fontWeight="bold" color="gray.400" fontSize={16}>#履歴強化</Text>
                            <Text fontWeight="bold" color="gray.400" fontSize={16}>#国際奉仕</Text>
                        </HStack>
                    </VStack>
                </div>
                <div style={{ marginTop: "100px", display: "flex" }}>
                    <Text fontWeight="bold" fontSize={24} marginLeft={5}>韓国留学</Text>
                </div>
                <div>
                    <VStack>
        ...
        return (
            <>
                ...
                <div style={{ width: '100%', height: '25px', backgroundColor: '#f5f5f5', display: 'flex', justifyContent: 'flex-end' }}>
                    ...
                    <Link to="/simple">
                        <Text marginRight={10} cursor="pointer" _hover={{ textDecoration: "underline" }}></Text>
                    </Link>
                </div>
                <div style={{ marginTop: "80px" }}>
                    <VStack>
                        <Text fontWeight="bold" fontSize={32}>未来のグローバルリーダーになりたいですか？</Text>
                        <Text fontSize={25} lineHeight="1.0">大学生の皆さん、世界舞台で輝く準備はできましたか？</Text>
                        <Text fontSize={25} lineHeight="1.0">Tutiの革新的なAI教育プラットフォームが</Text>
                        <Text fontSize={25} lineHeight="1.0">あなたをグローバルな才能にする生まれ変わる最適な仲間です。</Text>
                        <Text fontSize={25} lineHeight="1.0">今すぐお問い合わせください！</Text>
                    </VStack>
                </div>
                <div style={{ marginTop: "120px" }}>
                    <VStack>
                        <Text fontWeight="bold" fontSize={28}>登録する準備ができましたか？</Text>
                    </VStack>
                </div>
                <div style={{ marginTop: "20px" }}>
                    <VStack>
                        <ExternalLinkButton url="https://forms.gle/rmfDTTALSMHzTaEt8" text="今応募してください" />
                    </VStack>
                </div>
                <div style={{ width: '100%', marginTop: "120px", display: "flex", justifyContent: 'center' }}>

                    <HStack spacing={10} marginLeft={5}>
                        <Text fontWeight="bold" color="gray.400" fontSize={19}>#交換学生</Text>
                        <Text fontWeight="bold" color="gray.400" fontSize={19}>#インターンシップ</Text>
                        <Text fontWeight="bold" color="gray.400" fontSize={19}>#国際交流</Text>
                        <Text fontWeight="bold" color="gray.400" fontSize={19}>#進路探索</Text>
                        <Text fontWeight="bold" color="gray.400" fontSize={19}>#履歴強化</Text>
                        {/* <Text fontWeight="bold" color="gray.400" fontSize={19}>#国際奉仕</Text> */}
                    </HStack>

                </div>
                <div style={{ marginTop: "120px", display: "flex" }}>
                    <Text fontWeight="bold" fontSize={30} marginLeft={10}>韓国留学</Text>
                </div>
                <div>
                    <VStack>
